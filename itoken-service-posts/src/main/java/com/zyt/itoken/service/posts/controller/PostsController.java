package com.zyt.itoken.service.posts.controller;
...
public class PostsController {
    ...
    public BaseResult save(String tbPostsPostJson, String optsBy) {
        int result = 0;
    ...
    @ApiImplicitParams ({
            ...
            @ApiImplicitParam(name = "tbPostsPostJson", value = "管理员对象 JSON 字符串", required = false, dataTypeClass = String.class, paramType = "json")    })
